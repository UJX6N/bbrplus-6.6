# bbrplus-6.6
Linux BBRplus Kernel 6.6 LTS ported from BBRplus 4.14  
...
### 1) get convert patch on this repository, use git or direct download
        (e.g., convert_official_linux-6.6.x_src_to_bbrplus.patch)
...
### 3) extract the tarball & cd extracted directory
        tar xvf linux-6.6.16.tar.xz && cd linux-6.6.16
